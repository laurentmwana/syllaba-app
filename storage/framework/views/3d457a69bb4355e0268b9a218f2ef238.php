...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Les articles <?php $__env->endSlot(); ?>
        ...
        <div class="container-center">
            ...
            <div class="grid lg:grid-cols-4 gap-3 items-start my-5">
                <div class="container-card">
                    ...
                    <?php echo $__env->make('post._category', ['categories' => $categories], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="lg:col-span-3">
                    <div class="grid  grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <?php echo $__env->make('post._card', ['post' => $post], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?><?php /**PATH F:\laravel-app\syllaba-app\resources\views/post/index.blade.php ENDPATH**/ ?>