<form class="space-y-4"
    action="<?php echo e($category->id ? route('#category.update', ['id' => $category->id]) : route('#category.store')); ?>" method="POST">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['class' => 'block w-full','value' => ''.e($category->id ? $category->name : old('name')).'','id' => 'name','name' => 'name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'block w-full','value' => ''.e($category->id ? $category->name : old('name')).'','id' => 'name','name' => 'name']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.textarea','data' => ['class' => 'block w-full','value' => ''.e($category->id ? $category->description : old('description')).'','id' => 'description','name' => 'description']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'block w-full','value' => ''.e($category->id ? $category->description : old('description')).'','id' => 'description','name' => 'description']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH F:\laravel-app\syllaba-app\resources\views/admin/category/_form.blade.php ENDPATH**/ ?>