<div class="w-full shadow-sm border rounded-md">
    <div class="p-3 space-y-3">
        ...
        <p class="text-description mb-3">
            <?php echo e(Str::limit($document->description, 100)); ?>

        </p>

        <p class="text-description font-bold text-base mb-5">
            <?php echo e(formatAmount($document->price)); ?>
...
<?php endif; ?>
            ...
            <?php if($document->id % 2 === 0): ?>
            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['isLink' => true,'href' => route('document.index', ['id' => $document->id])]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['isLink' => true,'href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('document.index', ['id' => $document->id]))]); ?>
                En savoir plus
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['isLink' => true,'href' => route('document.index', ['id' => $document->id])]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
</div><?php /**PATH F:\laravel-app\syllaba-app\resources\views/document/_card.blade.php ENDPATH**/ ?>