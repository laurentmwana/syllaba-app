...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Gestion des newLetters <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php $__currentLoopData = $newLetters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newLetter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if (isset($component)) { $__componentOriginalce497eb0b465689d7cb385400a2cd821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce497eb0b465689d7cb385400a2cd821 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.row','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('table.row'); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <a href="<?php echo e(route('#user.show', ['id' => $newLetter->user->id])); ?>" class="hover:underline">
                                        <?php echo e(Str::limit($newLetter->user->name, 50)); ?>
...
<?php endif; ?><?php /**PATH F:\laravel-app\syllaba-app\resources\views/admin/new-letter/index.blade.php ENDPATH**/ ?>