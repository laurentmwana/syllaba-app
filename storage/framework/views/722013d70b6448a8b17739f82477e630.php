<form action="<?php echo e(route('card.remove-all')); ?>" method="post" onsubmit="return confirm('Voulez-vous vraiment vider ce panier ? ')">
    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.outline-button','data' => ['title' => 'Vider ce panier','type' => 'submit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Vider ce panier','type' => 'submit']); ?>
        Vider le panier
...
<?php endif; ?>
</form><?php /**PATH F:\laravel-app\syllaba-app\resources\views/card/_remove-all.blade.php ENDPATH**/ ?>