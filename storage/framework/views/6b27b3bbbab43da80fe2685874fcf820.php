...
<?php $component->withAttributes(['backRoute' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('#tome.index'))]); ?>
     <?php $__env->slot('header', null, []); ?> Editer le tome #<?php echo e($tome->id); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="container py-12">
        <div class="container-center">
            <div class="container-card max-w-xl">
                ...
                <?php echo $__env->make('admin.tome._form', [
                'tome' => $tome,
...
<?php endif; ?><?php /**PATH F:\laravel-app\syllaba-app\resources\views/admin/tome/edit.blade.php ENDPATH**/ ?>