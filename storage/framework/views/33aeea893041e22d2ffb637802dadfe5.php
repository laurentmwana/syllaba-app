...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Gestion des tomes <?php $__env->endSlot(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Support de cours <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php $__currentLoopData = $tomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tome): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if (isset($component)) { $__componentOriginalce497eb0b465689d7cb385400a2cd821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce497eb0b465689d7cb385400a2cd821 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.row','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('table.row'); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <a href="<?php echo e(route('#tome.show', ['id' => $tome->id])); ?>" class="hover:underline">
                                        <?php echo e(Str::limit($tome->courseDocument->title, 50)); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <a href="<?php echo e(route('#course.show', ['id' => $tome->courseDocument->course->id])); ?>" class="hover:underline">
                                        <?php echo e(Str::limit($tome->courseDocument->course->name, 50)); ?>
...
<?php endif; ?><?php /**PATH F:\laravel-app\syllaba-app\resources\views/admin/tome/index.blade.php ENDPATH**/ ?>