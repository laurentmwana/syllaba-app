...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Gestion des paiements <?php $__env->endSlot(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Etudiant <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Document <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal187ec4d26e72d09ba1cb8caa8ea74439)): ?>
<?php $attributes = $__attributesOriginal187ec4d26e72d09ba1cb8caa8ea74439; ?>
<?php unset($__attributesOriginal187ec4d26e72d09ba1cb8caa8ea74439); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <a href="<?php echo e(route('#student.show', ['id' => $payment->student->id])); ?>" class="hover:underline">
                                        <?php echo e(Str::limit($payment->student->name . " " . $payment->student->firstname, 50)); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <a href="<?php echo e(route('#document.show', ['id' => $payment->document->id])); ?>" class="hover:underline">
                                        <?php echo e(Str::limit($payment->document->title, 50)); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <a href="<?php echo e(route('#payment.show', ['id' => $payment->id])); ?>" class="hover:underline">
                                        <?php echo e(Str::limit($payment->alias, 10)); ?>
...
<?php endif; ?><?php /**PATH F:\laravel-app\syllaba-app\resources\views/admin/payment/index.blade.php ENDPATH**/ ?>