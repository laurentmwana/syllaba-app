    ...
    <div class="p-3 space-y-3">
        ...
        <div class="flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('post.index', ['id' => $post->id]) }}#author">
            ...
            <div>
                <a class="text-description text-[11px] " href="{{ route('post.index', ['id' => $post->id]) }}#author">
        ...
        @if ($post->id % 2 === 0)
        <x-secondary-button :isLink="true" :href="route('post.index', ['id' => $post->id])">
            En savoir plus
        </x-secondary-button>
        @else
        <x-primary-button :isLink="true" :href="route('post.index', ['id' => $post->id])">
            En savoir plus
        </x-primary-button>
        @endif
    </div>
